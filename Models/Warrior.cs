...
namespace JDR.Models
{
    public class Warrior : Hero
    {
        ...
        public override void LowTierAttack(Character target, Action restartGameAction)
        {
            ...
            string message = isCritical ? "Critical hit! " : "";
            message += $"Hero Strike from {Name} dealt {calculatedDamage} damage to {target.Name}.";
        ...
        public override async void MidTierAttack(Character target, Action refreshUI)
        {
            ...
            Console.WriteLine($"{target.Name} uses Protector's Will! Armor value increased temporarily.");
            ...
            Console.WriteLine($"{target.Name}'s Protector's Will has worn off. Armor value returns to normal.");
        ...
        public override void UltimateAttack(Character target, Action restartGameAction)
        {
            ...
            string message = isCritical ? "Critical hit! " : "";
            message += $"Divine Judgment from {Name} dealt {calculatedDamage} damage to {target.Name}.";
